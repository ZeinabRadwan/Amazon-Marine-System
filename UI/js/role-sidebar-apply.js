...
(function() {
    ...
    var R = {
        admin: { allowedPages: ['dashboard.html','clients.html','shipments.html','sd-forms.html','operations.html','invoices.html','accounting.html','treasury.html','expenses.html','pricing.html','partners.html','reports.html','documents.html','attendance.html','visits.html','customer-service.html','tickets.html','settings.html','cost-viewer.html','profile.html'], user: 'Capt. Mostafa', nameAr: 'مدير النظام', initials: 'MD' },
        ...
        support: { allowedPages: ['dashboard.html','clients.html','shipments.html','customer-service.html','tickets.html','visits.html','invoices.html','attendance.html','profile.html','settings.html'], user: 'سارة الدعم', nameAr: 'الدعم الفني', initials: 'SD' },
