...
class FileRecord extends Model
{
    ...
    /**
     * Relationship: The owning model (polymorphic).
     */
    ...
    /**
     * Relationship: The user who uploaded the file.
     */
     ...
     * Caches for 55 minutes for cloud providers.
     */
    public function getUrl(int $expiresInMinutes = 60): string
    {
        ...
        // Cache signed URLs (not local ones)
