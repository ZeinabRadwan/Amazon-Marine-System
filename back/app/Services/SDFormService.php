...
class SDFormService
{
    ...
    public static function transitionStatus(SDForm $form, string $toStatus): void
    {
        ...
        $allowedTransitions = [
            ...
            'in_progress' => ['completed', 'booking_confirmed', 'booking_cancelled', 'information_requested', 'converted_to_shipment', 'cancelled'],
            'booking_confirmed' => ['in_progress', 'completed', 'booking_cancelled', 'information_requested', 'converted_to_shipment', 'cancelled'],
            'booking_cancelled' => ['sent_to_operations', 'booking_in_progress', 'information_requested', 'cancelled'],
