...
class UpdateSDFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['sometimes', 'string', 'in:draft,submitted,sent_to_operations,booking_in_progress,information_requested,in_progress,booking_confirmed,booking_cancelled,converted_to_shipment,completed,cancelled'],
