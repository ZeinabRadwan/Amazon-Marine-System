    ...
    private function transportInstructionPdfExtraLabels(string $locale): array
    {
        if ($locale === 'ar') {
            return [
                ...
                'sec_ti_4_customs' => 'البيانات الجمركية',
                'sec_ti_5_generator' => 'المولد ودرجة الحرارة',
                'ti_container_summary' => 'ملخص الحاوية',
                'ti_maps_open' => 'فتح في خرائط جوجل',
        ...
        return [
            ...
            'sec_ti_4_customs' => 'Customs information',
            'sec_ti_5_generator' => 'Generator & temperature control',
            'ti_container_summary' => 'Container summary',
            'ti_maps_open' => 'Open in Google Maps',
