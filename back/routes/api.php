...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'track_session'])->group(function () {
        ...
        // Accounting
        Route::get('accounting/partner-statement-shipment-costs', [AccountingController::class, 'partnerStatementShipmentCosts']);
        ...
        Route::get('invoices/{invoice}/preview-html', [InvoiceController::class, 'previewHtml']);
